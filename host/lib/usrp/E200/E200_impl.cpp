...
//        _product_mp = U220;
//        // try to match the given device address with something on the USB bus
//        uint16_t vid       = E200_VENDOR_ID;
//        uint16_t pid       = E200_PRODUCT_ID;
...
//                usb_device_handle::vid_pid_pair_t(vid, E200_PRODUCT_ID));
//            vid_pid_pair_list.push_back(
//                usb_device_handle::vid_pid_pair_t(vid, E200MINI_PRODUCT_ID));
//            vid_pid_pair_list.push_back(
//                usb_device_handle::vid_pid_pair_t(vid, E205MINI_PRODUCT_ID));
//            vid_pid_pair_list.push_back(
//                usb_device_handle::vid_pid_pair_t(vid, E200_PRODUCT_NI_ID));
//            vid_pid_pair_list.push_back(
//                usb_device_handle::vid_pid_pair_t(vid, E210_PRODUCT_NI_ID));
//        }
//        // Search for all supported VIDs limited to specified PID if only PID specified
//        else if (specified_pid) {
//            vid_pid_pair_list.push_back(
//                usb_device_handle::vid_pid_pair_t(E200_VENDOR_ID, pid));
//            vid_pid_pair_list.push_back(
//                usb_device_handle::vid_pid_pair_t(E200_VENDOR_NI_ID, pid));
//        }
//        // Search for all supported devices if neither VID nor PID specified
//        else {
//            vid_pid_pair_list.push_back(
//                usb_device_handle::vid_pid_pair_t(E200_VENDOR_ID, E200_PRODUCT_ID));
//            vid_pid_pair_list.push_back(
//                usb_device_handle::vid_pid_pair_t(E200_VENDOR_ID, E200MINI_PRODUCT_ID));
//            vid_pid_pair_list.push_back(
//                usb_device_handle::vid_pid_pair_t(E200_VENDOR_ID, E205MINI_PRODUCT_ID));
//            vid_pid_pair_list.push_back(
//                usb_device_handle::vid_pid_pair_t(E200_VENDOR_NI_ID, E200_PRODUCT_NI_ID));
//            vid_pid_pair_list.push_back(
//                usb_device_handle::vid_pid_pair_t(E200_VENDOR_NI_ID, E210_PRODUCT_NI_ID));
//        }
//
...
//        _iface                    = e200_iface::make(control);
...
//            .set(mb_eeprom)
//            .add_coerced_subscriber(boost::bind(&e200_impl::set_mb_eeprom, this, _1));
//
//        ////////////////////////////////////////////////////////////////////
...
//            _product          = get_e200_product(handle, mb_eeprom);
//            default_file_name = E2XX_FPGA_FILE_NAME.get(_product);
//            product_name      = E2XX_STR_NAMES.get(_product);
...
//        }
//
//        UHD_LOGGER_INFO("B200") << "Detected Device: " << E2XX_STR_NAMES[_product];
//
...
//        UHD_LOGGER_INFO("E200") << "Operating over USB " << (int)usb_speed << ".";
